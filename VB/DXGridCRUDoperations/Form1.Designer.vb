...
Namespace DXGridCRUDoperations
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			' mFile
			' 
			Me.mFile.Caption = "&Menu" & Constants.vbCrLf
			Me.mFile.Id = 0
			Me.mFile.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() { New DevExpress.XtraBars.LinkPersistInfo(Me.iAdd), New DevExpress.XtraBars.LinkPersistInfo(Me.iInsert), New DevExpress.XtraBars.LinkPersistInfo(Me.iCopy), New DevExpress.XtraBars.LinkPersistInfo(Me.iPaste), New DevExpress.XtraBars.LinkPersistInfo(Me.iDelete), New DevExpress.XtraBars.LinkPersistInfo(Me.barButtonItem1)})
			Me.mFile.Name = "mFile"
			' 
			' iAdd
			' 
...
'			Me.iInsert.ItemClick += New DevExpress.XtraBars.ItemClickEventHandler(Me.iInsert_ItemClick);
			' 
			' iCopy
			' 
			...
			Me.iCopy.Id = 7
			Me.iCopy.Name = "iCopy"
'			Me.iCopy.ItemClick += New DevExpress.XtraBars.ItemClickEventHandler(Me.iCopy_ItemClick);
			' 
			' iPaste
			' 
...
'			Me.iPaste.ItemClick += New DevExpress.XtraBars.ItemClickEventHandler(Me.iPaste_ItemClick);
			' 
			' iDelete
			' 
